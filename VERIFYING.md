...
- duplicate declarations, including record/function name overlaps, record
  ...
  `main` declarations with parameters, unbound variables, unbound assignment
  targets, duplicate `let` bindings, unknown call targets, Dolo function arity
  mismatches, observed Herbert built-in arity mismatches, invalid `new_array`
